...
- system-tree: 5 个分支全部建立
- experiences-tree: 7 条核心行为准则 (EXP-CORE-0001~0008)
- projects-tree: 8 活跃项目
- 初始化状态: **已完成** (2026-04-30)
- 系统驱动: **已激活** (2026-05-12, system_drive.py + signals.json)
...
2. 加载核心行为准则 (EXP-CORE-0001~0008) ← 不可跳过
3. 执行垃圾回收 (L0 清理)
...
7. **系统维护与状态管理**: 定期检查磁盘/内存/GPU → 清理垃圾 → 状态变更自动 git 版本化 → 工具交叉联动
