...
## 这是什么
记忆森林是本环境所有记忆的唯一管理框架。它位于文档系统之上，是一切信息存储与检索的第一入口。
...
## 优先级法则
1. 会话启动时，forest-root 最先被访问，先于 MEMORY.md
2. forest-root 决定加载哪些树、哪些节点
3. 文档系统（17个规范文件）是 system-tree 的叶子节点
4. 若 forest-root 与任何其他规范冲突，forest-root 胜出
